namespace NarayanaGames.BeatTheRhythm.Maps.Enums {
    ...
    public enum GameplayEventType {
        /// <summary>
        ///     *Beat*, Note, also Tatum => notes that can be caught, punched,
        ///     sliced, shot => one "instant".
        ///     These have a location but no duration! Was previously called "Orb"
        /// </summary>
        Beat = 0, 
        
        /// <summary>
        ///     A combined series of beats. Similar to Trace in that it
        ...
        /// <summary>
        ///     A 2D or 3D path that has to be followed continuously.
        ///     It has a location (where the path begins), duration, and path
        ///     (number of times between 0 and 1 and corresponding locations).
        ///     Aka Slider (osu!), Tracer, Path, naming things is difficult ;-)
        /// </summary>
        Trace = 1,      
        
        /// <summary>
        ///     A special kind of held note where players need to "spin the wheel".
        ///     Added to have full osu! support, are called "Spinners" in osu!.
        /// </summary>
        Spin = 3,
